    ...
    )
{
    ...
    pThread->Parent = parentThread;
    InsertHeadList(&parentThread->ChildrenHead, &pThread->Children);
    ...
    )
{
    ...
    __try
    {
        ...
        if (AllocateKernelStack)
        {
            ...
            InitializeListHead(&pThread->ChildrenHead);
        }
